...
{
	public partial class frm_packs : mainFormPacks
    {
        public frm_packs()
        {
            InitializeComponent();		  
        ...
        private void frm_packs_Load(object sender, EventArgs e)
        {
           // SetModelsCar();
       //     setMenuForPakcs();
        ...
        private void frm_packs_eventSaveToDelete()
        {

        }

        private void frm_packs_eventSaveToEdit()
        {
        ...
        private void frm_packs_eventSaveToNew()
        {
			frmPackM = new gatepass.ui.package.frm_GatePassesGatePlace ();
		...
		void  frm_packs_eventSaveToSearch()
		{
		...
		private void frm_packs_eventSaveToView()
        {
        ...
        private void frm_packs_eventAfterSave()
        {
			frmPackM.Close ();
			frmPackM.Dispose ();
        }
        ...
        private void frm_packs_eventStatusDelete()
        {

        }

        private void frm_packs_eventStatusEdit()
        {
        ...
        private void frm_packs_eventStatusNew()
        {
          //  uC_packDetailsGates1.rtbOffice.Focus();
			//cbbSave_Click ( null , null );
        ...
        private void frm_packs_eventStatusSearch()
        {
        ...
        private void frm_packs_eventStatusView()
        {
