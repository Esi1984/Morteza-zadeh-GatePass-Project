...
{
	public partial class frm_GatePasses : Form
	{
		...
		{
			uC_packDetails1.rbtnAgree.Enabled = uC_packDetails1.rddlTypePack.SelectedIndex < 2 && cbbSave.Enabled;
			...
			//}	 
			if (uC_packDetails1.rcbHaveVehicle.Checked && cbbEdit.Enabled)
			{
		...
		public frm_GatePasses()
		{
			try
			{
				...
				uC_packDetails1.uC_vehicleDetails21.SetModelsCar();
			}
			catch (Exception ex)
			{
			...
			try
			{
				if (true)
				{
					...
					if (!IsnewRowAdded && MainRadGridView.SelectedRows.Count == 1)
					{
						SetPicIfHaveRight();
						ShowPropertiesItems();
						cbbDriver.Enabled = uC_packDetails1.rcbHaveVehicle.Checked && MainRadGridView.CurrentRow != null &&
						                    cbbEdit.Enabled;
						rightCbbDriver.Enabled = cbbDriver.Enabled;
						...
						cbbExpire.Enabled = MainRadGridView.CurrentRow != null
						                    ...
						                    (rgvPack != null &&
						                     ...
						                     AllFunctions._StatusPack.Passage);
		...
		protected void cbbEdit_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				frmSet.SetSettings(this.uC_packDetails1);
				frmSet.ShowDialog();
				if (frmSet.DialogResult == DialogResult.OK)
				{
					MainRadGridView.CurrentRow = null;
					this.SetSetting(frmSet.uC_packDetailsForNew1);
					objManager.ChangeStatus(aorc.gatepass.ItemsPublic.IndexStatus.setPack);
		...
		private void cbbSearch_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					//uC_packDetails1.rcbHaveVehicle.Checked = true;
		...
		private void frm_GatePasses_Load(object sender, EventArgs e)
		{
			...
			uC_packDetails1.uC_vehicleDetails21.rtbColor.Tag = uC_packDetails1.uC_vehicleDetails21.rtbColor.Tag + "L";
			uC_packDetails1.uC_vehicleDetails21.rtbModel.Tag = uC_packDetails1.uC_vehicleDetails21.rtbModel.Tag + "L";
			uC_packDetails1.uC_vehicleDetails21.uC_CarNumber1.CarNumberTags =
				uC_packDetails1.uC_vehicleDetails21.uC_CarNumber1.CarNumberTags + "L";
			uC_packDetails1.uC_vehicleDetails21.rddlState.Tag = uC_packDetails1.uC_vehicleDetails21.rddlState.Tag + "L";
			uC_packDetails1.uC_vehicleDetails21.rddlType.Tag = uC_packDetails1.uC_vehicleDetails21.rddlType.Tag + "L";
...
//....................
		...
		private void setPackInfo()
		{
			...
			uC_packDetails1.rddlShift.Text = rgvPack.CurrentRow.Cells["Package_Shift"].Value.ToString().Trim();

			uC_packDetails1.rtbStatusPack.Text = rgvPack.CurrentRow.Cells["StatusPack_Label"].Value.ToString().Trim();
			uC_packDetails1.rtbOffice.Text = rgvPack.CurrentRow.Cells["Office_Name"].Value.ToString().Trim();
			...
			uC_packDetails1.rtbNumberAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Number"].Value.ToString().Trim();
			...
			uC_packDetails1.rtbCompanyAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Company"].Value.ToString().Trim();
			uC_packDetails1.rtbTitleAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Title"].Value.ToString().Trim();
			uC_packDetails1.rlblCountCar.Text = ItemsPublic.HowManyCarInAgree(temp);
			...
			uC_packDetails1.rtbOperRequest.Text = rgvPack.CurrentRow.Cells["OperRequestName"].Value.ToString().Trim();
			uC_packDetails1.rtbOperConfirm.Text = rgvPack.CurrentRow.Cells["OperConfirmName"].Value.ToString().Trim();
			uC_packDetails1.rtbOperPassage.Text = rgvPack.CurrentRow.Cells["OperPassageName"].Value.ToString().Trim();
			uC_packDetails1.tbPackDescriptions.Text =
				rgvPack.CurrentRow.Cells["Package_Description"].Value.ToString().Trim();

			//uC_packDetails1.uC_vehicleDetails21.rddlType.SelectedIndex =
			uC_packDetails1.rcbHaveVehicle.Checked =
				!string.IsNullOrEmpty(rgvPack.CurrentRow.Cells["Vehicle_ID"].Value.ToString().Trim());
			if (uC_packDetails1.rcbHaveVehicle.Checked)
			{
				uC_packDetails1.CurrentCarId = (decimal?) rgvPack.CurrentRow.Cells["Vehicle_ID"].Value;
				...
				uC_packDetails1.uC_vehicleDetails21.rddlState.SelectedIndex =
			...
			{
				uC_packDetails1.rcbHaveVehicle.Checked = false;
			}
		}

		private void setEmptyInfo()
		{
			uC_packDetails1.CurrentCarId = null;
			CurrentDriverId = null;
			uC_packDetails1.rtbStatusPack.Text = "درحال ساخت";
			uC_packDetails1.rtbOffice.Text = "";
			uC_packDetails1.rddlTypePack.SelectedIndex = -1;
			uC_packDetails1.bdcStartDate.DateTime = null;
			uC_packDetails1.bdcEndDate.DateTime = null;
			uC_packDetails1.rddlValid.SelectedIndex = -1;
			uC_packDetails1.rtbNumberAgree.Text = "";
			uC_packDetails1.CurrentAgreeId = null;
			uC_packDetails1.rtbCompanyAgree.Text = "";
			uC_packDetails1.rtbTitleAgree.Text = "";

			uC_packDetails1.CurrentTravelId = null;

			uC_packDetails1.rtbTravelLabel.Text = "";

			uC_packDetails1.rtbOperRequest.Text = "";
			uC_packDetails1.rtbOperConfirm.Text = "";
			uC_packDetails1.rtbOperPassage.Text = "";
			uC_packDetails1.tbPackDescriptions.Text = "";
			uC_packDetails1.rcbHaveVehicle.Checked = false;
			uC_packDetails1.uC_vehicleDetails21.rtbModel.Text = "";
			uC_packDetails1.uC_vehicleDetails21.rtbColor.Text = "";
			uC_packDetails1.uC_vehicleDetails21.uC_CarNumber1.CarNumber = "";
			uC_packDetails1.uC_vehicleDetails21.rddlState.SelectedIndex = -1;
			uC_packDetails1.uC_vehicleDetails21.indexTypeModel = null;
		}
	...
	uC_ViewPersonDetails1.bdcEndSecureDate.DateTime = (DateTime?) null;
		...
		private void cbbNoPassage_Click(object sender, EventArgs e)
		{
			try
			{
				...
				result = objManager.ClsPacksGps_passage(IndexPack, AllFunctions._StatusPack.NoPassage,frmDialog.message,null);
				if (result.success)
				{
		...
		private void cbbNoConfirm_Click(object sender, EventArgs e)
		{
			try
			{
				...
				result = objManager.ClsPacksGps_confirm(IndexPack, AllFunctions._StatusPack.NoConfirm,frmDialog.message, new DataTable());
				if (result.success)
				{
		...
		private void cbbPassage_Click(object sender, EventArgs e)
		{
			try
			{
                ...
                result = objManager.ClsPacksGps_passage(IndexPack, AllFunctions._StatusPack.Passage, frmDialog.message, new DataTable());
				if (result.success)
				{
		...
		private void cbbConfirm_Click(object sender, EventArgs e)
		{
			try
			{
                ...
                result = objManager.ClsPacksGps_confirm(IndexPack, AllFunctions._StatusPack.Confirm, frmDialog.message, new DataTable());
				if (result.success)
				{
			...
			try
			{
				...
				if (isNew)
				{
                    result = objManager.ClsPacksGps_insertPackGpsOldVersion(
						(uC_packDetails1.bdcStartDate.SelectedDate != null)
							? uC_packDetails1.bdcStartDate.SelectedDate.Value
							: (DateTime?) null,
						(uC_packDetails1.bdcEndDate.SelectedDate != null)
							? uC_packDetails1.bdcEndDate.SelectedDate.Value
							: (DateTime?) null,
						uC_packDetails1.CurrentAgreeId,
						uC_packDetails1.CurrentTravelId,
						uC_packDetails1.tbPackDescriptions.Text.Trim(), uC_packDetails1.rddlTypePack.SelectedIndex, personsId,
						personIdDriver(),
						uC_packDetails1.CurrentCarId, pos, uC_packDetails1.rddlShift.Text.Trim(),
						null,null);
					if (result.success)
					{
				...
				else
				{
                    result = objManager.ClsPacksGps_updatePackGpsOldVersion(
						IndexPack,
						uC_packDetails1.tbPackDescriptions.Text.Trim(),
						uC_packDetails1.CurrentAgreeId,
						uC_packDetails1.CurrentTravelId,
						(uC_packDetails1.bdcStartDate.SelectedDate != null)
							? uC_packDetails1.bdcStartDate.SelectedDate.Value
						...
						(uC_packDetails1.bdcEndDate.SelectedDate != null)
							? uC_packDetails1.bdcEndDate.SelectedDate.Value
							: (DateTime?) null,
						uC_packDetails1.rddlTypePack.SelectedIndex, personsId, personIdDriver(), uC_packDetails1.CurrentCarId, pos,
						uC_packDetails1.rddlShift.Text.Trim () , null , null );
					if (result.success)
					{
						MessageBox.Show("عملیات با موفقیت انجام شد");
						if (pos != AllFunctions._StatusPack.Create)
		...
		private void uC_packDetails1_eventTickVehicle()
		{
			try
			{
				cbbDriver.Enabled = uC_packDetails1.rcbHaveVehicle.Checked && MainRadGridView.CurrentRow != null && cbbEdit.Enabled;
				//eventStatusView();
				//	MainRadGridView.Enabled = true;
				//	objManager.ChangeStatus ( aorc.gatepass.ItemsPublic.IndexStatus.viewPack );
				if (uC_packDetails1.rcbHaveVehicle.Checked)
		...
		public void SetSetting(UC_packDetailsForNew obj)
		{
			uC_packDetails1.rddlTypePack.SelectedIndex = obj.rddlTypePack.SelectedIndex;
			uC_packDetails1.bdcStartDate.DateTime = obj.bdcStartDate.DateTime;
			uC_packDetails1.bdcEndDate.DateTime = obj.bdcEndDate.DateTime;
			uC_packDetails1.rtbNumberAgree.Text = obj.rtbNumberAgree.Text.Trim();
			uC_packDetails1.CurrentAgreeId = obj.CurrentAgreeId;
			uC_packDetails1.rtbCompanyAgree.Text = obj.rtbCompanyAgree.Text.Trim();
			uC_packDetails1.rtbTitleAgree.Text = obj.rtbTitleAgree.Text.Trim();
			uC_packDetails1.rlblCountCar.Text = obj.rlblCountCar.Text.Trim();
			uC_packDetails1.rddlShift.Text = obj.rddlShift.Text.Trim();

			uC_packDetails1.CurrentTravelId = obj.CurrentTravelId;

			uC_packDetails1.rtbTravelLabel.Text = obj.rtbTravelLabel.Text.Trim();

			uC_packDetails1.tbPackDescriptions.Text = obj.tbPackDescriptions.Text.Trim();

			//uC_packDetails1.uC_vehicleDetails21.rddlType.SelectedIndex =
			uC_packDetails1.rcbHaveVehicle.Checked = obj.rcbHaveVehicle.Checked;
			if (uC_packDetails1.rcbHaveVehicle.Checked)
			{
				uC_packDetails1.CurrentCarId = obj.CurrentCarId;
				uC_packDetails1.uC_vehicleDetails21.rtbModel.Text =
				...
				uC_packDetails1.uC_vehicleDetails21.indexTypeModel = obj.uC_vehicleDetails21.indexTypeModel;
			}
		}
		...
		private void setAllRightMenusCopy()
		{
			...
			this.rightCbbSecure.Image = global::aorc.gatepass.Properties.Resources.operators;
