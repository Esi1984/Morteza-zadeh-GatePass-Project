...
{
	public partial class frm_packsBackUp01 : mainFormPacks
    {
        public frm_packsBackUp01()
        {
            InitializeComponent();		  
        }
		frm_GatePassesGatePlace frmPackM = new frm_GatePassesGatePlace ();
        private void frm_packsBackUp01_Load(object sender, EventArgs e)
        {
           // SetModelsCar();
       //     setMenuForPakcs();
		...
		setAllMouseMenus ();
        	...
        	uC_rightSidePacks1.SelectFirst();
        ...
        private void frm_packsBackUp01_eventSaveToDelete()
        {
		...
		void  frm_packsBackUp01_eventSaveToSearch()
		{
			var frm = new frm_3Search();
			frm.ShowDialog();
			if (frm.DialogResult == DialogResult.OK)
			{
				uC_rightSidePacks1.UnSelect();
		...
		private void frm_packsBackUp01_eventSaveToView()
        {
			//AllFunctions._StatusPack? sad = uC_rightSidePacks1.CurrentStatusPack;
            result = objManager.View_packages(null, uC_rightSidePacks1.CurrentStatusPack, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        }

        private void frm_packsBackUp01_eventAfterSave()
        {
			frmPackM.Close ();
			frmPackM.Dispose ();
        }
        ...
        private void frm_packsBackUp01_eventStatusDelete()
        {

        }

        private void frm_packsBackUp01_eventStatusEdit()
        {
        ...
        private void frm_packsBackUp01_eventStatusNew()
        {
          //  uC_packDetailsGates1.rtbOffice.Focus();
			//cbbSave_Click ( null , null );
        ...
        private void frm_packsBackUp01_eventStatusSearch()
        {
        ...
        private void frm_packsBackUp01_eventStatusView()
        {
		...
		private void uC_rightSidePacks1_eventNodeNoConfirm()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.NoConfirm, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
		...
		private void uC_rightSidePacks1_eventNodeNoPass()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.NoPassage, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
				MainRadGridView.DataSource = result.ResultTable;
				MainRadGridView.Columns ["package_Id"].SortOrder = RadSortOrder.Descending;
		...
		private void uC_rightSidePacks1_eventNodePassed()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.Passage, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
				MainRadGridView.DataSource = result.ResultTable;
				MainRadGridView.Columns ["package_Id"].SortOrder = RadSortOrder.Descending;
		...
		private void uC_rightSidePacks1_eventNodeWaitConfirm()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.Request, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
				MainRadGridView.DataSource = result.ResultTable;
				MainRadGridView.Columns ["package_Id"].SortOrder = RadSortOrder.Descending;
		...
		private void uC_rightSidePacks1_eventNodeWaitPass()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.Confirm, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
				MainRadGridView.DataSource = result.ResultTable;
				MainRadGridView.Columns ["package_Id"].SortOrder = RadSortOrder.Descending;
		...
		private void uC_rightSidePacks1_eventNodeWaitRequest()
		{
            result = objManager.View_packages(false, AllFunctions._StatusPack.Create, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
			if ( result.success )
			{
				MainRadGridView.DataSource = result.ResultTable;
				MainRadGridView.Columns ["package_Id"].SortOrder = RadSortOrder.Descending;
