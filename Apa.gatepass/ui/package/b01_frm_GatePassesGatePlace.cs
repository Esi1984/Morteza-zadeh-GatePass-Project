...
{
	public partial class b01_frm_GatePassesGatePlace : Form
	{
		...
		{
			uC_packDetailsGatePlace1.rbtnAgree.Enabled = uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex < 2 &&
			                                             cbbSave.Enabled;
			...
			//      cbbSecureForm.Enabled=false;
			//} 
			if (uC_packDetailsGatePlace1.rcbHaveVehicle.Checked && cbbEdit.Enabled)
			{
		...
		public b01_frm_GatePassesGatePlace()
		{
			try
			{
				InitializeComponent();
				...
				uC_packDetailsGatePlace1.uC_vehicleDetails21.SetModelsCar();
			}
			catch (Exception ex)
			{
			...
			try
			{
				if (true)
				{
					...
					if (!IsnewRowAdded && MainRadGridView.SelectedRows.Count == 1)
					{
						SetPicIfHaveRight();
						ShowPropertiesItems();
						cbbDriver.Enabled = uC_packDetailsGatePlace1.rcbHaveVehicle.Checked && MainRadGridView.CurrentRow != null &&
						                    cbbEdit.Enabled &&
		...
		protected void cbbEdit_Click(object sender, EventArgs e)
		{
			try
			{
				...
				var frmSet = new gatepass.ui.package.b01_frm_SettingPackGatePlace();
				frmSet.SetSettings(this.uC_packDetailsGatePlace1);
				frmSet.ShowDialog();
				if (frmSet.DialogResult == DialogResult.OK)
				{
					MainRadGridView.CurrentRow = null;
					this.SetSetting(frmSet.uC_packDetailsNewGatePlace1);
					objManager.ChangeStatus(aorc.gatepass.ItemsPublic.IndexStatus.setPack);
		...
		private void cbbSearch_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					//uC_packDetailsGatePlace1.rcbHaveVehicle.Checked = true;
					CurrentDriverId = (decimal) MainRadGridView.CurrentRow.Cells["Person_ID"].Value;
					if (uC_packDetailsGatePlace1.rcbHaveVehicle.Checked)
					{
		...
		private void b01_frm_GatePassesGatePlace_Load(object sender, EventArgs e)
		{
			...
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbColor.Tag =
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbColor.Tag + "L";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbModel.Tag =
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbModel.Tag + "L";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.uC_CarNumber1.CarNumberTags =
				uC_packDetailsGatePlace1.uC_vehicleDetails21.uC_CarNumber1.CarNumberTags + "L";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlState.Tag =
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlState.Tag + "L";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlType.Tag =
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlType.Tag + "L";
...
//....................
		...
		private void setPackInfo()
		{
			...
			if (result.success)
			{
				...
				uC_packDetailsGatePlace1.rtbGates.Text = "";
				uC_packDetailsGatePlace1.CurrentGates = new List<int>();
				foreach (DataRow obj in result.ResultTable.Rows)
				{
					...
					uC_packDetailsGatePlace1.CurrentGates.Add(int.Parse(obj["Gate_Id"].ToString().Trim()));
					uC_packDetailsGatePlace1.rtbGates.Text += obj["Gate_Name"].ToString().Trim() + "\r\n";
				}
			}
			else
			{
			...
			if (result.success)
			{
				uC_packDetailsGatePlace1.rtbPlaces.Text = "";
				uC_packDetailsGatePlace1.CurrentPlaces = new List<int>();
				foreach (DataRow obj in result.ResultTable.Rows)
				{
					//	string ss = obj.Cells["Place_Id"].Value.ToString().Trim();
					//int ii = int.Parse(obj.Cells["Place_Id"].Value.ToString().Trim());
					uC_packDetailsGatePlace1.CurrentPlaces.Add(int.Parse(obj["Place_Id"].ToString().Trim()));
					uC_packDetailsGatePlace1.rtbPlaces.Text += obj["Place_Name"].ToString().Trim() + "\r\n";
				}
			}
			else
			{
			...
			uC_packDetailsGatePlace1.rddlShift.Text = rgvPack.CurrentRow.Cells["Package_Shift"].Value.ToString().Trim();

			uC_packDetailsGatePlace1.rtbStatusPack.Text = rgvPack.CurrentRow.Cells["StatusPack_Label"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.rtbOffice.Text = rgvPack.CurrentRow.Cells["Office_Name"].Value.ToString().Trim();
			switch ((ServerClasses.AllFunctions._TypePack) rgvPack.CurrentRow.Cells["TypePack_Id"].Value)
			{
				case ServerClasses.AllFunctions._TypePack.WorkerMan:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.WorkerMan;
					break;
				case ServerClasses.AllFunctions._TypePack.WorkerWoman:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.WorkerWoman;
					break;
				case ServerClasses.AllFunctions._TypePack.TeachTrainee:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.TeachTrainee;
					break;
				case ServerClasses.AllFunctions._TypePack.TeachUni:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.TeachUni;
					break;
				case ServerClasses.AllFunctions._TypePack.TeachAct:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.TeachAct;
					break;
				case ServerClasses.AllFunctions._TypePack.Guest:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.Guest;
					break;
				case ServerClasses.AllFunctions._TypePack.TempWork:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.TempWork;
					break;
				case ServerClasses.AllFunctions._TypePack.Company:
					uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = (int) ServerClasses.AllFunctions._TypePack.Company;
					break;
			}
			uC_packDetailsGatePlace1.bdcStartDate.DateTime = (DateTime) rgvPack.CurrentRow.Cells["Package_StartDate"].Value;
			uC_packDetailsGatePlace1.bdcEndDate.DateTime = (DateTime) rgvPack.CurrentRow.Cells["Package_EndDate"].Value;
			uC_packDetailsGatePlace1.rddlValid.SelectedIndex = ((bool) rgvPack.CurrentRow.Cells["Package_IsExpired"].Value)
			                                                   	? 0
			                                                   	: 1;
			uC_packDetailsGatePlace1.rtbNumberAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Number"].Value.ToString().Trim();
			...
			uC_packDetailsGatePlace1.CurrentAgreeId = temp;
			uC_packDetailsGatePlace1.rtbCompanyAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Company"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.rtbTitleAgree.Text = rgvPack.CurrentRow.Cells["Agreement_Title"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.rlblCountCar.Text = ItemsPublic.HowManyCarInAgree(temp);
			...
			uC_packDetailsGatePlace1.CurrentTravelId = temp2;

			uC_packDetailsGatePlace1.rtbTravelLabel.Text =
				rgvPack.CurrentRow.Cells["TravelArea_LabelTravel"].Value.ToString().Trim();

			uC_packDetailsGatePlace1.rtbOperRequest.Text = rgvPack.CurrentRow.Cells["OperRequestName"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.rtbOperConfirm.Text = rgvPack.CurrentRow.Cells["OperConfirmName"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.rtbOperPassage.Text = rgvPack.CurrentRow.Cells["OperPassageName"].Value.ToString().Trim();
			uC_packDetailsGatePlace1.tbPackDescriptions.Text =
				rgvPack.CurrentRow.Cells["Package_Description"].Value.ToString().Trim();

			//uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlType.SelectedIndex =
			string stV = rgvPack.CurrentRow.Cells["Vehicle_ID"].Value.ToString().Trim();
			bool boV = !string.IsNullOrEmpty(stV);
			uC_packDetailsGatePlace1.rcbHaveVehicle.Checked = boV;
			if (uC_packDetailsGatePlace1.rcbHaveVehicle.Checked)
			{
				uC_packDetailsGatePlace1.CurrentCarId = (decimal?) rgvPack.CurrentRow.Cells["Vehicle_ID"].Value;
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbModel.Text =
					rgvPack.CurrentRow.Cells["Vehicle_Model"].Value.ToString().Trim();
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbColor.Text =
					rgvPack.CurrentRow.Cells["vehicle_Color"].Value.ToString().Trim();
				uC_packDetailsGatePlace1.uC_vehicleDetails21.uC_CarNumber1.CarNumber =
					rgvPack.CurrentRow.Cells["Vehicle_number"].Value.ToString().Trim();
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlState.SelectedIndex =
					(bool) rgvPack.CurrentRow.Cells["Vehicle_IsCompany"].Value ? 0 : 1;
				uC_packDetailsGatePlace1.uC_vehicleDetails21.indexTypeModel =
					(int?) rgvPack.CurrentRow.Cells["VehicleType_ID"].Value;
			}
			else
			{
				uC_packDetailsGatePlace1.rcbHaveVehicle.Checked = false;
			}
		}

		private void setEmptyInfo()
		{
			uC_packDetailsGatePlace1.CurrentCarId = null;
			CurrentDriverId = null;
			uC_packDetailsGatePlace1.rtbStatusPack.Text = "درحال ساخت";
			uC_packDetailsGatePlace1.rtbOffice.Text = "";
			uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = -1;
			uC_packDetailsGatePlace1.bdcStartDate.DateTime = null;
			uC_packDetailsGatePlace1.bdcEndDate.DateTime = null;
			uC_packDetailsGatePlace1.rddlValid.SelectedIndex = -1;
			uC_packDetailsGatePlace1.rtbNumberAgree.Text = "";
			uC_packDetailsGatePlace1.CurrentAgreeId = null;
			uC_packDetailsGatePlace1.rtbCompanyAgree.Text = "";
			uC_packDetailsGatePlace1.rtbTitleAgree.Text = "";

			uC_packDetailsGatePlace1.CurrentTravelId = null;

			uC_packDetailsGatePlace1.rtbTravelLabel.Text = "";

			uC_packDetailsGatePlace1.rtbOperRequest.Text = "";
			uC_packDetailsGatePlace1.rtbOperConfirm.Text = "";
			uC_packDetailsGatePlace1.rtbOperPassage.Text = "";
			uC_packDetailsGatePlace1.tbPackDescriptions.Text = "";
			uC_packDetailsGatePlace1.rcbHaveVehicle.Checked = false;
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbModel.Text = "";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbColor.Text = "";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.uC_CarNumber1.CarNumber = "";
			uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlState.SelectedIndex = -1;
			uC_packDetailsGatePlace1.uC_vehicleDetails21.indexTypeModel = null;
		}
...
//	{
			...
			try
			{
				...
				if (isNew)
				{
                    result = objManager.ClsPacksGps_insertPackGpsOldVersion(
						(uC_packDetailsGatePlace1.bdcStartDate.SelectedDate != null)
							? uC_packDetailsGatePlace1.bdcStartDate.SelectedDate.Value
							: (DateTime?) null,
						(uC_packDetailsGatePlace1.bdcEndDate.SelectedDate != null)
							? uC_packDetailsGatePlace1.bdcEndDate.SelectedDate.Value
							: (DateTime?) null,
						uC_packDetailsGatePlace1.CurrentAgreeId,
						uC_packDetailsGatePlace1.CurrentTravelId,
						uC_packDetailsGatePlace1.tbPackDescriptions.Text.Trim(), uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex,
						personsId,
						personIdDriver(),
						uC_packDetailsGatePlace1.CurrentCarId, pos, uC_packDetailsGatePlace1.rddlShift.Text.Trim()
						, uC_packDetailsGatePlace1.CurrentGates, uC_packDetailsGatePlace1.CurrentPlaces);
					if (result.success)
					{
				...
				else
				{
                    result = objManager.ClsPacksGps_updatePackGpsOldVersion(
						IndexPack,
						uC_packDetailsGatePlace1.tbPackDescriptions.Text.Trim(),
						uC_packDetailsGatePlace1.CurrentAgreeId,
						uC_packDetailsGatePlace1.CurrentTravelId,
						(uC_packDetailsGatePlace1.bdcStartDate.SelectedDate != null)
							? uC_packDetailsGatePlace1.bdcStartDate.SelectedDate.Value
						...
						(uC_packDetailsGatePlace1.bdcEndDate.SelectedDate != null)
							? uC_packDetailsGatePlace1.bdcEndDate.SelectedDate.Value
							: (DateTime?) null,
						uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex, personsId, personIdDriver(),
						uC_packDetailsGatePlace1.CurrentCarId, pos,
						uC_packDetailsGatePlace1.rddlShift.Text.Trim()
						, uC_packDetailsGatePlace1.CurrentGates, uC_packDetailsGatePlace1.CurrentPlaces);
					if (result.success)
					{
		...
		private void uC_packDetailsGatePlace1_eventTickVehicle()
		{
			try
			{
				cbbDriver.Enabled = uC_packDetailsGatePlace1.rcbHaveVehicle.Checked && MainRadGridView.CurrentRow != null &&
		...
		public void SetSetting(UC_packDetailsNewGatePlace obj)
		{
			uC_packDetailsGatePlace1.rtbPlaces.Text = obj.rtbPlaces.Text.Trim();
			uC_packDetailsGatePlace1.CurrentPlaces = obj.CurrentPlaces;

			uC_packDetailsGatePlace1.rtbGates.Text = obj.rtbGates.Text.Trim();
			uC_packDetailsGatePlace1.CurrentGates = obj.CurrentGates;

			uC_packDetailsGatePlace1.rddlTypePack.SelectedIndex = obj.rddlTypePack.SelectedIndex;
			uC_packDetailsGatePlace1.bdcStartDate.DateTime = obj.bdcStartDate.DateTime;
			uC_packDetailsGatePlace1.bdcEndDate.DateTime = obj.bdcEndDate.DateTime;
			uC_packDetailsGatePlace1.rtbNumberAgree.Text = obj.rtbNumberAgree.Text.Trim();
			uC_packDetailsGatePlace1.CurrentAgreeId = obj.CurrentAgreeId;
			uC_packDetailsGatePlace1.rtbCompanyAgree.Text = obj.rtbCompanyAgree.Text.Trim();
			uC_packDetailsGatePlace1.rtbTitleAgree.Text = obj.rtbTitleAgree.Text.Trim();
			uC_packDetailsGatePlace1.rlblCountCar.Text = obj.rlblCountCar.Text.Trim();
			uC_packDetailsGatePlace1.rddlShift.Text = obj.rddlShift.Text.Trim();

			uC_packDetailsGatePlace1.CurrentTravelId = obj.CurrentTravelId;

			uC_packDetailsGatePlace1.rtbTravelLabel.Text = obj.rtbTravelLabel.Text.Trim();

			uC_packDetailsGatePlace1.tbPackDescriptions.Text = obj.tbPackDescriptions.Text.Trim();

			//uC_packDetailsGatePlace1.uC_vehicleDetails21.rddlType.SelectedIndex =
			uC_packDetailsGatePlace1.rcbHaveVehicle.Checked = obj.rcbHaveVehicle.Checked;
			if (uC_packDetailsGatePlace1.rcbHaveVehicle.Checked)
			{
				uC_packDetailsGatePlace1.CurrentCarId = obj.CurrentCarId;
				uC_packDetailsGatePlace1.uC_vehicleDetails21.rtbModel.Text =
				...
				uC_packDetailsGatePlace1.uC_vehicleDetails21.indexTypeModel = obj.uC_vehicleDetails21.indexTypeModel;
			}
		}
		...
		private void b01_frm_GatePassesGatePlace_Shown(object sender, EventArgs e)
		{
			if (pmStatus == ItemsPublic.IndexStatus.toNew)
			{
				cbbNew_Click(sender, e);
