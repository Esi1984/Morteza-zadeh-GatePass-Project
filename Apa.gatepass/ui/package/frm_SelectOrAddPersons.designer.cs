...
{
    partial class frm_SelectOrAddPersons
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.cbbSelect = new Telerik.WinControls.UI.CommandBarButton ();
			this.cbbUnSelect = new Telerik.WinControls.UI.CommandBarButton ();
			...
			this.rtbSex = new Telerik.WinControls.UI.RadTextBox ();
			this.rbtnSelectPerson = new Telerik.WinControls.UI.RadButton ();
			...
			this.rtbSearchPerson = new Telerik.WinControls.UI.RadMaskedEditBox ();
			...
			( ( System.ComponentModel.ISupportInitialize ) ( this.rtbSex ) ).BeginInit ();
			( ( System.ComponentModel.ISupportInitialize ) ( this.rbtnSelectPerson ) ).BeginInit ();
			...
			( ( System.ComponentModel.ISupportInitialize ) ( this.rtbSearchPerson ) ).BeginInit ();
			...
			this.radStatusStrip1.Location = new System.Drawing.Point ( 0 , 469 );
			this.radStatusStrip1.Name = "radStatusStrip1";
			this.radStatusStrip1.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.radStatusStrip1.Size = new System.Drawing.Size ( 416 , 24 );
			...
			this.rmiStatusSettingPrint.Class = "";
			...
			this.radMenu1.Size = new System.Drawing.Size ( 416 , 19 );
			...
			this.radPanel1.Size = new System.Drawing.Size ( 416 , 56 );
			...
			this.RadCommandBar1MainF.Size = new System.Drawing.Size ( 416 , 55 );
			...
			// cbbSelect
			// 
			this.cbbSelect.AccessibleDescription = "ویرایش";
			this.cbbSelect.AccessibleName = "ویرایش";
			this.cbbSelect.DisplayName = "انتخاب";
			this.cbbSelect.DrawText = true;
			this.cbbSelect.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 178 ) ) );
			this.cbbSelect.Image = global::aorc.gatepass.Properties.Resources.edit;
			this.cbbSelect.Name = "cbbSelect";
			this.cbbSelect.Tag = "av";
			this.cbbSelect.Text = "انتخاب";
			this.cbbSelect.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
			this.cbbSelect.Visibility = Telerik.WinControls.ElementVisibility.Hidden;
			this.cbbSelect.Click += new System.EventHandler ( this.cbbSelect_Click );
			// 
			// cbbUnSelect
			// 
			this.cbbUnSelect.AccessibleDescription = "حذف";
			this.cbbUnSelect.AccessibleName = "حذف";
			this.cbbUnSelect.DisplayName = "رد انتخاب";
			this.cbbUnSelect.DrawText = true;
			this.cbbUnSelect.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 178 ) ) );
			this.cbbUnSelect.Image = global::aorc.gatepass.Properties.Resources.blue_recycle_bin_icon;
			this.cbbUnSelect.Name = "cbbUnSelect";
			this.cbbUnSelect.Tag = "av";
			this.cbbUnSelect.Text = "رد انتخاب";
			this.cbbUnSelect.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
			this.cbbUnSelect.Visibility = Telerik.WinControls.ElementVisibility.Hidden;
			this.cbbUnSelect.Click += new System.EventHandler ( this.cbbUnSelect_Click );
			// 
			// radDock1
			// 
			...
			this.radDock1.Size = new System.Drawing.Size ( 416 , 394 );
			...
			// documentWindow2
			// 
			this.documentWindow2.Controls.Add ( this.radGridViewSearch );
			this.documentWindow2.Controls.Add ( this.radGridViewSelected );
			this.documentWindow2.Controls.Add ( this.rtbSex );
			this.documentWindow2.Controls.Add ( this.rbtnSelectPerson );
			this.documentWindow2.Controls.Add ( this.radLabel8 );
			this.documentWindow2.Controls.Add ( this.rlblSurname );
			this.documentWindow2.Controls.Add ( this.rlblName );
			this.documentWindow2.Controls.Add ( this.rtbSurname );
			this.documentWindow2.Controls.Add ( this.rtbName );
			this.documentWindow2.Controls.Add ( this.rgbDescriptions );
			...
			this.documentWindow2.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.documentWindow2.Size = new System.Drawing.Size ( 394 , 349 );
			this.documentWindow2.Text = "جستجو";
			// 
			// radGridViewSearch
			// 
			...
			this.radGridViewSearch.ForeColor = System.Drawing.SystemColors.ControlText;
			this.radGridViewSearch.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			this.radGridViewSearch.Location = new System.Drawing.Point ( 469 , 70 );
			// 
			// radGridViewSearch
			// 
			this.radGridViewSearch.MasterTemplate.AddNewRowPosition = Telerik.WinControls.UI.SystemRowPosition.Bottom;
			this.radGridViewSearch.MasterTemplate.AllowAddNewRow = false;
			this.radGridViewSearch.MasterTemplate.AutoGenerateColumns = false;
			gridViewDecimalColumn1.EnableExpressionEditor = false;
			gridViewDecimalColumn1.FieldName = "Person_ID";
			gridViewDecimalColumn1.HeaderText = "آیدی شخص";
			...
			gridViewDateTimeColumn1.FieldName = "Person_BirthDate";
			gridViewDateTimeColumn1.Format = System.Windows.Forms.DateTimePickerFormat.Long;
			gridViewDateTimeColumn1.HeaderText = "تاریخ تولد";
			gridViewDateTimeColumn1.IsVisible = false;
			gridViewDateTimeColumn1.Name = "Person_BirthDate";
			...
			gridViewCheckBoxColumn3.FieldName = "GatePass_IsDriver";
			gridViewCheckBoxColumn3.HeaderText = "GatePass_IsDriver";
			gridViewCheckBoxColumn3.IsVisible = false;
			gridViewCheckBoxColumn3.MinWidth = 20;
			gridViewCheckBoxColumn3.Name = "GatePass_IsDriver";
			gridViewDateTimeColumn2.EnableExpressionEditor = false;
			gridViewDateTimeColumn2.FieldName = "GatePass_TimeLock";
			gridViewDateTimeColumn2.Format = System.Windows.Forms.DateTimePickerFormat.Long;
			gridViewDateTimeColumn2.HeaderText = "GatePass_TimeLock";
			gridViewDateTimeColumn2.IsVisible = false;
			gridViewDateTimeColumn2.Name = "GatePass_TimeLock";
			gridViewCheckBoxColumn4.EnableExpressionEditor = false;
			gridViewCheckBoxColumn4.FieldName = "Person_Temp";
			gridViewCheckBoxColumn4.HeaderText = "موقت";
			gridViewCheckBoxColumn4.IsVisible = false;
			gridViewCheckBoxColumn4.MinWidth = 20;
			gridViewCheckBoxColumn4.Name = "Person_Temp";
			gridViewTextBoxColumn14.FieldName = "CountPrinted";
			gridViewTextBoxColumn14.HeaderText = "دفعات چاپ";
			gridViewTextBoxColumn14.IsVisible = false;
			gridViewTextBoxColumn14.Name = "CountPrinted";
			...
			this.radGridViewSearch.MasterTemplate.EnableAlternatingRowColor = true;
			this.radGridViewSearch.MasterTemplate.ShowColumnHeaders = false;
			this.radGridViewSearch.MasterTemplate.ShowRowHeaderColumn = false;
			sortDescriptor1.Direction = System.ComponentModel.ListSortDirection.Descending;
			sortDescriptor1.PropertyName = "columnnumber";
			this.radGridViewSearch.MasterTemplate.SortDescriptors.AddRange ( new Telerik.WinControls.Data.SortDescriptor [] {
            sortDescriptor1} );
			...
			this.radGridViewSearch.ShowGroupPanel = false;
			this.radGridViewSearch.Size = new System.Drawing.Size ( 27 , 12 );
			this.radGridViewSearch.TabIndex = 75;
			this.radGridViewSearch.Text = "radGridView1";
			this.radGridViewSearch.Visible = false;
			// 
			// radGridViewSelected
			// 
			...
			this.radGridViewSelected.ForeColor = System.Drawing.SystemColors.ControlText;
			this.radGridViewSelected.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			this.radGridViewSelected.Location = new System.Drawing.Point ( 0 , 95 );
			// 
			// radGridViewSelected
			// 
			this.radGridViewSelected.MasterTemplate.AllowAddNewRow = false;
			this.radGridViewSelected.MasterTemplate.AutoGenerateColumns = false;
			gridViewDecimalColumn6.EnableExpressionEditor = false;
			gridViewDecimalColumn6.FieldName = "Person_ID";
			gridViewDecimalColumn6.HeaderText = "آیدی شخص";
			gridViewDecimalColumn6.IsVisible = false;
			gridViewDecimalColumn6.Name = "Person_ID";
			gridViewDecimalColumn6.Width = 66;
			gridViewDecimalColumn7.EnableExpressionEditor = false;
			gridViewDecimalColumn7.FieldName = "Gatepass_ID";
			gridViewDecimalColumn7.HeaderText = "آیدی گیت پاس";
			gridViewDecimalColumn7.IsVisible = false;
			gridViewDecimalColumn7.Name = "Gatepass_ID";
			gridViewDecimalColumn7.Width = 110;
			gridViewTextBoxColumn15.EnableExpressionEditor = false;
			gridViewTextBoxColumn15.FieldName = "Person_Name";
			gridViewTextBoxColumn15.HeaderText = "نام";
			gridViewTextBoxColumn15.Name = "Person_Name";
			gridViewTextBoxColumn15.Width = 119;
			gridViewTextBoxColumn16.EnableExpressionEditor = false;
			gridViewTextBoxColumn16.FieldName = "Person_Surname";
			gridViewTextBoxColumn16.HeaderText = "نام خانوادگی";
			gridViewTextBoxColumn16.Name = "Person_Surname";
			gridViewTextBoxColumn16.Width = 195;
			gridViewTextBoxColumn17.EnableExpressionEditor = false;
			gridViewTextBoxColumn17.FieldName = "Person_NationalCode";
			gridViewTextBoxColumn17.HeaderText = "شماره ملی";
			gridViewTextBoxColumn17.IsVisible = false;
			gridViewTextBoxColumn17.Name = "Person_NationalCode";
			gridViewTextBoxColumn17.Width = 145;
			gridViewTextBoxColumn18.EnableExpressionEditor = false;
			gridViewTextBoxColumn18.FieldName = "Person_IdentifyCode";
			gridViewTextBoxColumn18.HeaderText = "شماره شناسایی";
			gridViewTextBoxColumn18.IsVisible = false;
			gridViewTextBoxColumn18.Name = "Person_IdentifyCode";
			gridViewTextBoxColumn18.Width = 103;
			gridViewTextBoxColumn19.EnableExpressionEditor = false;
			gridViewTextBoxColumn19.FieldName = "Person_LicenseDriverCode";
			gridViewTextBoxColumn19.HeaderText = "شماره گواهینامه رانندگی";
			gridViewTextBoxColumn19.IsVisible = false;
			gridViewTextBoxColumn19.Name = "Person_LicenseDriverCode";
			gridViewTextBoxColumn19.Width = 168;
			gridViewTextBoxColumn20.EnableExpressionEditor = false;
			gridViewTextBoxColumn20.FieldName = "Person_FatherName";
			gridViewTextBoxColumn20.HeaderText = "نام پدر";
			gridViewTextBoxColumn20.IsVisible = false;
			gridViewTextBoxColumn20.Name = "Person_FatherName";
			gridViewTextBoxColumn20.Width = 109;
			gridViewTextBoxColumn21.EnableExpressionEditor = false;
			gridViewTextBoxColumn21.FieldName = "Person_BirthCity";
			gridViewTextBoxColumn21.HeaderText = "محل تولد";
			gridViewTextBoxColumn21.IsVisible = false;
			gridViewTextBoxColumn21.Name = "Person_BirthCity";
			gridViewTextBoxColumn21.Width = 106;
			gridViewTextBoxColumn22.EnableExpressionEditor = false;
			gridViewTextBoxColumn22.FieldName = "Person_RegisterCity";
			gridViewTextBoxColumn22.HeaderText = "محل صدور شناسنامه";
			gridViewTextBoxColumn22.IsVisible = false;
			gridViewTextBoxColumn22.Name = "Person_RegisterCity";
			gridViewTextBoxColumn23.EnableExpressionEditor = false;
			gridViewTextBoxColumn23.FieldName = "Person_Nationality";
			gridViewTextBoxColumn23.HeaderText = "تابعیت";
			gridViewTextBoxColumn23.IsVisible = false;
			gridViewTextBoxColumn23.Name = "Person_Nationality";
			gridViewTextBoxColumn23.Width = 64;
			gridViewTextBoxColumn24.EnableExpressionEditor = false;
			gridViewTextBoxColumn24.FieldName = "Person_Phone1";
			gridViewTextBoxColumn24.HeaderText = "شماره تماس اول";
			gridViewTextBoxColumn24.IsVisible = false;
			gridViewTextBoxColumn24.Name = "Person_Phone1";
			gridViewTextBoxColumn25.EnableExpressionEditor = false;
			gridViewTextBoxColumn25.FieldName = "Person_Phone2";
			gridViewTextBoxColumn25.HeaderText = "شماره تماس دوم";
			gridViewTextBoxColumn25.IsVisible = false;
			gridViewTextBoxColumn25.Name = "Person_Phone2";
			gridViewTextBoxColumn26.EnableExpressionEditor = false;
			gridViewTextBoxColumn26.FieldName = "Person_RegisterCode";
			gridViewTextBoxColumn26.HeaderText = "شماره شناسنامه";
			gridViewTextBoxColumn26.IsVisible = false;
			gridViewTextBoxColumn26.Name = "Person_RegisterCode";
			gridViewTextBoxColumn26.Width = 121;
			gridViewCheckBoxColumn5.EnableExpressionEditor = false;
			gridViewCheckBoxColumn5.FieldName = "Person_HaveForm";
			gridViewCheckBoxColumn5.HeaderText = "فرم حفاظتی";
			gridViewCheckBoxColumn5.IsVisible = false;
			gridViewCheckBoxColumn5.MinWidth = 20;
			gridViewCheckBoxColumn5.Name = "Person_HaveForm";
			gridViewCheckBoxColumn5.Width = 106;
			gridViewCheckBoxColumn6.EnableExpressionEditor = false;
			gridViewCheckBoxColumn6.FieldName = "Person_isWoman";
			gridViewCheckBoxColumn6.HeaderText = "مونث";
			gridViewCheckBoxColumn6.IsVisible = false;
			gridViewCheckBoxColumn6.MinWidth = 20;
			gridViewCheckBoxColumn6.Name = "Person_isWoman";
			gridViewCheckBoxColumn6.Width = 31;
			gridViewImageColumn2.EnableExpressionEditor = false;
			gridViewImageColumn2.FieldName = "Person_Picture";
			gridViewImageColumn2.HeaderText = "عکس";
			gridViewImageColumn2.IsVisible = false;
			gridViewImageColumn2.Name = "Person_Picture";
			gridViewDateTimeColumn3.EnableExpressionEditor = false;
			gridViewDateTimeColumn3.FieldName = "Person_BirthDate";
			gridViewDateTimeColumn3.Format = System.Windows.Forms.DateTimePickerFormat.Long;
			gridViewDateTimeColumn3.HeaderText = "تاریخ تولد";
			gridViewDateTimeColumn3.IsVisible = false;
			gridViewDateTimeColumn3.Name = "Person_BirthDate";
			gridViewTextBoxColumn27.EnableExpressionEditor = false;
			gridViewTextBoxColumn27.FieldName = "Person_LabelIsWoman";
			gridViewTextBoxColumn27.HeaderText = "جنسیت";
			gridViewTextBoxColumn27.Name = "Person_LabelIsWoman";
			gridViewTextBoxColumn27.Width = 57;
			gridViewDecimalColumn8.EnableExpressionEditor = false;
			gridViewDecimalColumn8.FieldName = "package_Id";
			gridViewDecimalColumn8.HeaderText = "آیدی بسته";
			gridViewDecimalColumn8.IsVisible = false;
			gridViewDecimalColumn8.Name = "package_Id";
			gridViewDecimalColumn9.EnableExpressionEditor = false;
			gridViewDecimalColumn9.FieldName = "GatePass_IntPrint";
			gridViewDecimalColumn9.HeaderText = "GatePass_IntPrint";
			gridViewDecimalColumn9.IsVisible = false;
			gridViewDecimalColumn9.Name = "GatePass_IntPrint";
			gridViewDecimalColumn10.EnableExpressionEditor = false;
			gridViewDecimalColumn10.FieldName = "GatePass_LockerId";
			gridViewDecimalColumn10.HeaderText = "GatePass_LockerId";
			gridViewDecimalColumn10.IsVisible = false;
			gridViewDecimalColumn10.Name = "GatePass_LockerId";
			gridViewCheckBoxColumn7.EnableExpressionEditor = false;
			gridViewCheckBoxColumn7.FieldName = "GatePass_IsDriver";
			gridViewCheckBoxColumn7.HeaderText = "GatePass_IsDriver";
			gridViewCheckBoxColumn7.IsVisible = false;
			gridViewCheckBoxColumn7.MinWidth = 20;
			gridViewCheckBoxColumn7.Name = "GatePass_IsDriver";
			gridViewDateTimeColumn4.EnableExpressionEditor = false;
			gridViewDateTimeColumn4.FieldName = "GatePass_TimeLock";
			gridViewDateTimeColumn4.Format = System.Windows.Forms.DateTimePickerFormat.Long;
			gridViewDateTimeColumn4.HeaderText = "GatePass_TimeLock";
			gridViewDateTimeColumn4.IsVisible = false;
			gridViewDateTimeColumn4.Name = "GatePass_TimeLock";
			gridViewCheckBoxColumn8.EnableExpressionEditor = false;
			gridViewCheckBoxColumn8.FieldName = "Person_Temp";
			gridViewCheckBoxColumn8.HeaderText = "موقت";
			gridViewCheckBoxColumn8.IsVisible = false;
			gridViewCheckBoxColumn8.MinWidth = 20;
			gridViewCheckBoxColumn8.Name = "Person_Temp";
			gridViewTextBoxColumn28.EnableExpressionEditor = false;
			gridViewTextBoxColumn28.FieldName = "CountPrinted";
			gridViewTextBoxColumn28.HeaderText = "دفعات چاپ";
			gridViewTextBoxColumn28.IsVisible = false;
			gridViewTextBoxColumn28.Name = "CountPrinted";
			...
			this.radGridViewSelected.MasterTemplate.EnableAlternatingRowColor = true;
			...
			sortDescriptor2.PropertyName = "columnnumber";
			...
			this.radGridViewSelected.ShowGroupPanel = false;
			this.radGridViewSelected.Size = new System.Drawing.Size ( 394 , 251 );
			this.radGridViewSelected.TabIndex = 9;
			this.radGridViewSelected.Text = "radGridView1";
			this.radGridViewSelected.DoubleClick += new System.EventHandler ( this.radGridViewSelected_DoubleClick );
			// 
			// rtbSex
			// 
			this.rtbSex.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 0 ) ) );
			this.rtbSex.Location = new System.Drawing.Point ( 41 , 70 );
			this.rtbSex.Name = "rtbSex";
			this.rtbSex.ReadOnly = true;
			this.rtbSex.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.rtbSex.Size = new System.Drawing.Size ( 83 , 19 );
			this.rtbSex.TabIndex = 74;
			this.rtbSex.TabStop = false;
			this.rtbSex.Tag = "aens";
			this.rtbSex.ThemeName = "ControlDefault";
			// 
			// rbtnSelectPerson
			// 
			this.rbtnSelectPerson.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 0 ) ) );
			this.rbtnSelectPerson.Image = global::aorc.gatepass.Properties.Resources.arrow_270;
			this.rbtnSelectPerson.Location = new System.Drawing.Point ( 9 , 60 );
			this.rbtnSelectPerson.Name = "rbtnSelectPerson";
			this.rbtnSelectPerson.Size = new System.Drawing.Size ( 26 , 29 );
			this.rbtnSelectPerson.TabIndex = 73;
			this.rbtnSelectPerson.Tag = "ane";
			this.rbtnSelectPerson.Click += new System.EventHandler ( this.rbtnSelectPerson_Click );
			// 
			// radLabel8
			// 
			...
			this.radLabel8.Location = new System.Drawing.Point ( 80 , 49 );
			...
			this.rlblSurname.Location = new System.Drawing.Point ( 220 , 49 );
			...
			this.rlblName.Location = new System.Drawing.Point ( 375 , 49 );
			...
			this.rtbSurname.Location = new System.Drawing.Point ( 130 , 70 );
			this.rtbSurname.Name = "rtbSurname";
			this.rtbSurname.ReadOnly = true;
			this.rtbSurname.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.rtbSurname.Size = new System.Drawing.Size ( 157 , 19 );
			this.rtbSurname.TabIndex = 68;
			...
			this.rtbName.Location = new System.Drawing.Point ( 293 , 70 );
			this.rtbName.Name = "rtbName";
			this.rtbName.ReadOnly = true;
			this.rtbName.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.rtbName.Size = new System.Drawing.Size ( 101 , 19 );
			this.rtbName.TabIndex = 67;
			...
			this.rgbDescriptions.Controls.Add ( this.rtbSearchPerson );
			...
			this.rgbDescriptions.HeaderText = "بر اساس شماره ملی شخص";
			...
			this.rgbDescriptions.Size = new System.Drawing.Size ( 394 , 43 );
			this.rgbDescriptions.TabIndex = 7;
			this.rgbDescriptions.Text = "بر اساس شماره ملی شخص";
			// 
			// rtbSearchPerson
			// 
			this.rtbSearchPerson.AllowPromptAsInput = false;
			this.rtbSearchPerson.AutoSize = true;
			this.rtbSearchPerson.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 0 ) ) );
			this.rtbSearchPerson.Location = new System.Drawing.Point ( 5 , 20 );
			this.rtbSearchPerson.Mask = "0000000000";
			this.rtbSearchPerson.MaskType = Telerik.WinControls.UI.MaskType.Standard;
			this.rtbSearchPerson.MaxLength = 10;
			this.rtbSearchPerson.Name = "rtbSearchPerson";
			this.rtbSearchPerson.PlaceHolder = '-';
			this.rtbSearchPerson.PromptChar = '-';
			this.rtbSearchPerson.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.rtbSearchPerson.Size = new System.Drawing.Size ( 384 , 19 );
			this.rtbSearchPerson.TabIndex = 1101;
			this.rtbSearchPerson.TabStop = false;
			this.rtbSearchPerson.Tag = "aens";
			this.rtbSearchPerson.Text = "----------";
			this.rtbSearchPerson.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.rtbSearchPerson.TextChanged += new System.EventHandler ( this.rtbSearchPerson_TextChanged );
			// 
			// documentContainer1
			// 
			...
			this.documentContainer1.Size = new System.Drawing.Size ( 406 , 384 );
			...
			this.Name = "frm_SelectOrAddPersons";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "انتخاب افراد";
			this.Load += new System.EventHandler ( this.frm_SelectOrAddPersons_Load );
			...
			( ( System.ComponentModel.ISupportInitialize ) ( this.rtbSex ) ).EndInit ();
			( ( System.ComponentModel.ISupportInitialize ) ( this.rbtnSelectPerson ) ).EndInit ();
			...
			( ( System.ComponentModel.ISupportInitialize ) ( this.rtbSearchPerson ) ).EndInit ();
        ...
        public Telerik.WinControls.UI.RadGridView radGridViewSelected;
		...
		public Telerik.WinControls.UI.RadGridView radGridViewSearch;
		public Telerik.WinControls.UI.RadMaskedEditBox rtbSearchPerson;
		private Telerik.WinControls.UI.RadButton rbtnSelectPerson;
