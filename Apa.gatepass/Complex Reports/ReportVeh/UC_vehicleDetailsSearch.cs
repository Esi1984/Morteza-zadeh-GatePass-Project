...
{
    public partial class UC_vehicleDetailsSearch : UserControl
    {
        public UC_vehicleDetailsSearch()
        {
            InitializeComponent();
            uC_PlatesCar1.rddlTypePlate.Tag = "";
            uC_PlatesCar1.uC_PlatesMeli1.CarNumberTags = "";
            uC_PlatesCar1.uC_PlatesSimple1.CarNumberTags = "";
        }
		...
		public void SetModelsCar()
		{
            ...
            //}
			//	UC_vehicleDetailsSearch1.rddlType.DataSource = Models.ResultTable.Columns["VehicleType_Name"];
		}
        ...
        public void LimitedAcess()
        {
            rddlState.Visible = false;
            rddlType.Visible = false;
            rtbColor.Visible = false;
            rtbModel.Visible = false;
            rlblColor.Visible = false;
            rlblIsCompany.Visible = false;
            rlblModel.Visible = false;
            rlblType.Visible = false;
        }
    }
}
