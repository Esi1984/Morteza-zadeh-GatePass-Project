namespace aorc.gatepass
{
	partial class frm_GetMessage
    {
        ...
        private void InitializeComponent()
        {
			...
			this.radStatusStrip1.Location = new System.Drawing.Point ( 0 , 138 );
			this.radStatusStrip1.Name = "radStatusStrip1";
			this.radStatusStrip1.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.radStatusStrip1.Size = new System.Drawing.Size ( 481 , 24 );
			...
			this.radPanel1.Size = new System.Drawing.Size ( 481 , 56 );
			...
			this.RadCommandBar1MainF.Size = new System.Drawing.Size ( 481 , 97 );
			...
			this.radGroupBox3.Controls.Add ( this.rtbMessage );
			...
			this.radGroupBox3.HeaderText = "در صورتی که قصد رد بسته مورد نظر را دارید لطفا پس از ذکر دلیل کلید تایید را بفشار" +
    "ید";
			this.radGroupBox3.Location = new System.Drawing.Point ( 0 , 62 );
			...
			this.radGroupBox3.Size = new System.Drawing.Size ( 478 , 74 );
			this.radGroupBox3.TabIndex = 104;
			this.radGroupBox3.Text = "در صورتی که قصد رد بسته مورد نظر را دارید لطفا پس از ذکر دلیل کلید تایید را بفشار" +
    "ید";
			// 
			// rtbMessage
			// 
			this.rtbMessage.AutoScroll = true;
			this.rtbMessage.Font = new System.Drawing.Font ( "Tahoma" , 8.25F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( ( byte ) ( 0 ) ) );
			this.rtbMessage.Location = new System.Drawing.Point ( 9 , 17 );
			this.rtbMessage.Multiline = true;
			this.rtbMessage.Name = "rtbMessage";
			this.rtbMessage.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			// 
			// 
			// 
			this.rtbMessage.RootElement.StretchVertically = true;
			this.rtbMessage.Size = new System.Drawing.Size ( 460 , 52 );
			this.rtbMessage.TabIndex = 156;
			this.rtbMessage.TabStop = false;
			this.rtbMessage.Tag = "a";
			// 
			// frm_GetMessage
			// 
			...
			this.Name = "frm_GetMessage";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "پنجره تایید عملیات";
			this.Load += new System.EventHandler ( this.frm_GetMessage_Load );
			this.Shown += new System.EventHandler ( this.frm_GetMessage_Shown );
		...
		public Telerik.WinControls.UI.RadTextBox rtbMessage;
    }
}
