...
{
    public partial class frm_SelectOrAddPersonsGp2 : Form
    {
        public frm_SelectOrAddPersonsGp2()
        {
            try
            {
                InitializeComponent();
        ...
        private void SetProperty(string name, string surName, string sex)
{
	...
	rtbSex.Text = sex.Trim ();
        ...
        private void rtbSearchPerson_TextChanged(object sender, EventArgs e)
        {
            ...
            rtbSearchPerson.Text  = rtbSearchPerson.Text.Replace("\r\n", "");
		...
		private void frm_SelectOrAddPersonsGp2_Load(object sender, EventArgs e)
		{
			State = false;
		}
		...
		private void frm_SelectOrAddPersonsGp2_Shown( object sender , EventArgs e )
		{
			rtbSearchPerson.Focus ();
		}
		...
		{
            //MessageBox.Show(e.KeyCode.ToString()+":"+e.KeyData.ToString()+":"+e.KeyValue.ToString()+":"+ModifierKeys.ToString());
			if(e.KeyCode==Keys.Enter)
			{
				rbtnSelectPerson_Click(sender, e);													 
				return;
			}
            //if (e.KeyCode == Keys.V && ModifierKeys == Keys.ControlKey)
            //{
            //    //e.KeyCode == ModifierKeys("v")
            //    SendKeys.Send("^V");
            //    return;
            //}
            //if (e.KeyCode == Keys.C && ModifierKeys == Keys.ControlKey)
            //{
            //    //e.KeyCode == ModifierKeys("v")
            //    SendKeys.Send("^C");
            //    return;
