...
{
	public partial class frm_packsGp2 : mainFormPacks
    {
        public frm_packsGp2()
        {
            InitializeComponent();		  
        ...
        private void frm_packsGp2_Load(object sender, EventArgs e)
        {
           // SetModelsCar();
       //     setMenuForPakcs();
        ...
        private void frm_packsGp2_eventSaveToDelete()
        {

        }

        private void frm_packsGp2_eventSaveToEdit()
        {
        ...
        private void frm_packsGp2_eventSaveToNew()
        {
			frmPackM = new frm_InpackGP ();
		...
		void  frm_packsGp2_eventSaveToSearch()
		{
		...
		private void frm_packsGp2_eventSaveToView()
        {
        ...
        private void frm_packsGp2_eventAfterSave()
        {
			frmPackM.Close ();
			frmPackM.Dispose ();
        }
        ...
        private void frm_packsGp2_eventStatusDelete()
        {

        }

        private void frm_packsGp2_eventStatusEdit()
        {
        ...
        private void frm_packsGp2_eventStatusNew()
        {
          //  uC_packDetailsGates1.rtbOffice.Focus();
			//cbbSave_Click ( null , null );
        ...
        private void frm_packsGp2_eventStatusSearch()
        {
        ...
        private void frm_packsGp2_eventStatusView()
        {
