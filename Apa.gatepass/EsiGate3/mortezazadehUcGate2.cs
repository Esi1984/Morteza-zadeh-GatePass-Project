...
{
    public partial class mortezazadehUcGate2 : UserControl
    {
      ...
      //  public string labelMyGate = "";
        ...
        private void GetNews()
        {
            ...
            if (RNews.success)
            {
                ...
                if (seePassingCode!= -1 && RNews.MiniTable1 != null)
                {
//                    ShowPassingView();
                     ...
                     {
                       data =   (Byte[]) RNews.MiniTable1.Rows[0]["Person_Picture"];
                     }

                    morMonitoring1.ShowPersonPass(RNews.MiniTable1.Rows[0][""].ToString().Trim()
                        , RNews.MiniTable1.Rows[0][""].ToString().Trim()
                        ,ref data
                        ,(bool)RNews.MiniTable1.Rows[0][""]);
                }
